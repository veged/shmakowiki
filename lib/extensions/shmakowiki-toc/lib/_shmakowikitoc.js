var TocToList = {
    ...
    createLi: function(content, a) {
        return ['ulistItem', ['listItem', content ? this.createLink(content, a) : null]];
    },
...
};var api = require('../../../shmakowiki.js');var ometajs_ = require('ometajs').globals || global;var StringBuffer = ometajs_.StringBuffer;
        ...
        extension: function() {
            ...
            return this._or(function() {
                return function() {
                    ...
                    return [ t, tt, [ this.transform(c, p), c ], p ];
                }.call(this);
            }, function() {
                return function() {
                    this._form(function() {
